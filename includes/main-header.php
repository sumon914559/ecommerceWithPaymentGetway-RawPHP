...
<!-- ============================================================= SHOPPING CART DROPDOWN : END============================================================= -->				</div><!-- /.top-cart-row -->
			...
			<?php if($_SESSION['customerName'] !=''  ){ ?>       <!-- AND $_SESSION['orderNo'] !=''-->
			<div class="btn btn-success btn-block" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
				<span aria-hidden="true">&times;</span>
			  </button>
			  <strong>Congratulation! </strong>  <?php echo $_SESSION['customerName']; ?> , Your ORDER ID :
			  <b><?php echo $_SESSION['orderNo']; ?> , TRANSACTION ID : <?php echo $_SESSION['TransactionId'];?></b>.
			</div>
			<?php } unset($_SESSION['customerName']); unset($_SESSION['orderNo']); unset($_SESSION['TransactionId']);?>
		</div><!-- /.container -->
