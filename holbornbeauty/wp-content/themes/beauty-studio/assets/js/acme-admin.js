    ...
    at_document.ready( function() {
        ...
        function at_build_hide_unnecessary_meta() {
            var page_template = $('#page_template'),
                beauty_studio_sidebar_layout = $('#beauty_studio_sidebar_layout'),
                beauty_studio_meta_fields = $('#beauty_studio_meta_fields'),
            ...
            if( valueSelected === 'page-templates/template-builder.php' ){
                beauty_studio_sidebar_layout.addClass('hidden');
                beauty_studio_meta_fields.addClass('hidden');
                postimagediv.addClass('hidden');
            }
            else{
                beauty_studio_sidebar_layout.removeClass('hidden');
                beauty_studio_meta_fields.removeClass('hidden');
