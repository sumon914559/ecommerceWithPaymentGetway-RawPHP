 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Beauty_Studio_Service' ) ) {

	class Beauty_Studio_Service extends WP_Widget {
		...
		public function form( $instance ) {
            ...
            <br/>
            <small><?php esc_html_e( 'Add Page, Reorder and Remove. Please do not forget to add Icon and Excerpt on selected pages.', 'beauty-studio' ); ?></small>
                ...
                <div class="container">
                    ...
                    <div <?php echo $div_attr;?>>
						...
						if( !empty( $post_in )) :
							...
							$service_query = new WP_Query( $beauty_studio_post_in_page_args );
							...
							if ( $service_query->have_posts() ):
								...
								while ( $service_query->have_posts() ):$service_query->the_post();
									...
									?>
                                    <div class="<?php echo esc_attr( $beauty_studio_list_classes ); ?> column">
                                        <div class="single-item <?php echo esc_attr( $animation ); ?>">
                                            <div class="icon clearfix">
												<?php
												$beauty_studio_icon = get_post_meta( get_the_ID(), 'beauty-studio-featured-icon', true );
												$beauty_studio_icon = isset( $beauty_studio_icon ) ? esc_attr( $beauty_studio_icon ) : '';

												echo '<a href="'.esc_url(get_permalink()).'" class="all-link">';
												if ( ! empty ( $beauty_studio_icon ) ) { ?>
                                                    <i class="fa <?php echo esc_attr( $beauty_studio_icon ); ?>"></i>
													<?php
												}
												else {
	...
	} // Class Beauty_Studio_Service ends here
}