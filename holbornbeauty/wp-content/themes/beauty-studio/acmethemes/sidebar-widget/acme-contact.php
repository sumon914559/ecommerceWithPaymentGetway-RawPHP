 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Beauty_Studio_Contact' ) ) {

    class Beauty_Studio_Contact extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                    ...
                    esc_html__('AT Contact Section', 'beauty-studio'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Contact Section.', 'beauty-studio' )
                    )
            );
        }
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'shortcode' ) ); ?>"><?php esc_html_e( 'Enter Shortcode', 'beauty-studio' ); ?></label>
                ...
                <small>
                    <?php
                    printf( esc_html__( 'Download contact form 7 from %1$shere%2$s', 'beauty-studio' ), "<a target='_blank' href='".esc_url( 'https://wordpress.org/plugins/contact-form-7/' )."''>","</a>" );
                    ?>
                </small>
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php esc_html_e( 'Select Page For Contact', 'beauty-studio' ); ?></label>
                <br />
                <small><?php esc_html_e( 'Select page and its title and excerpt will display in the frontend. No need of subpages.', 'beauty-studio' ); ?></small>
                <?php
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'single_page_content_from' ) ); ?>"><?php esc_html_e( 'Page Content From', 'beauty-studio' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'single_page_content_number' ) ); ?>"><?php esc_html_e( 'Number of page words in content', 'beauty-studio' ); ?></label>
                <br/>
                <small>
        ...
        public function update( $new_instance, $old_instance ) {
            ...
            $instance[ 'page_id' ]              = beauty_studio_sanitize_page( $new_instance[ 'page_id' ] );

	        $beauty_studio_about_content_from           = beauty_studio_content_from();
	        $instance['single_page_content_from']       = beauty_studio_sanitize_choice_options( $new_instance['single_page_content_from'], $beauty_studio_about_content_from, 'content' );
                    ...
                    <div class="container">
                        <div class="row">
	                        ...
	                        if( !empty ( $page_id ) ) :
		                        ...
		                        $contact_page_query = new WP_Query( $beauty_studio_post_in_page_args );
		                        /*The Loop*/
                                        ...
                                        <div class="col-sm-6  <?php echo $animation; ?>">
                                            <div class="contact-page-content">
                                                ...
                                                if( 0 != $single_page_content_number ){
                                                    beauty_studio_advanced_content( $single_page_content_number, $single_page_content_from );
                                                }
                                                ?>
                                            </div>
                                        </div>
	                        ...
	                        ?>
                            <div class="col-sm-6  <?php echo $next_col.' '.$animation; ?>">
    ...
    } // Class Beauty_Studio_Contact ends here
}