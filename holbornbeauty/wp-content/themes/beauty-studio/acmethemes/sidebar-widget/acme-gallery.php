 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Beauty_Studio_Gallery' ) ) {

    class Beauty_Studio_Gallery extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <br/>
            <small><?php esc_html_e( 'Add Page, Reorder and Remove. Please do not forget to add Featured Image on selected pages. ', 'beauty-studio' ); ?></small>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'image_popup_type' ) ); ?>"><?php esc_html_e( 'Image Popup Type', 'beauty-studio' ); ?></label>
            ...
            <section id="<?php echo $unique_id;?>" class="at-widgets acme-gallery">
                <div class="full-width-container">
                    ...
                    if( !empty ( $post_in ) ) :
	                    ...
	                    $gallery_query = new WP_Query( $beauty_studio_post_in_page_args );
                        ?>
                        <div class="row fullwidth-row">
                            ...
                            if ( $gallery_query->have_posts() ):
                                ...
                                while( $gallery_query->have_posts() ):$gallery_query->the_post();
	                                if( 1 == $column_number ){
		                                $beauty_studio_column = " col-xs-12";
	                                }
                                    elseif( 2 == $column_number ){
		                                $beauty_studio_column = " col-sm-6";
	                                }
                                    elseif( 3 == $column_number ){
		                                $beauty_studio_column = " col-sm-4 col-md-4";
	                                }
                                    elseif( 4 == $column_number ){
		                                $beauty_studio_column = ' col-sm-3 col-md-3';
	                                }
	                                else{
		                                $beauty_studio_column = " col-sm-3 col-md-3";
	                                }
                                    ?>
                                    <div class="at-gallery-item <?php echo esc_attr( $beauty_studio_column ); ?>">
                                        <div class="gallery-inner-item <?php echo esc_attr( $animation );?>">
                                            ...
                                            if( has_post_thumbnail() ):
                                                $image_url = wp_get_attachment_image_src( get_post_thumbnail_id(), $beauty_studio_img_size );
                                            else:
    ...
    } // Class Beauty_Studio_Gallery ends here
}