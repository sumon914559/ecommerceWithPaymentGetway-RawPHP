<?php
/**
 * Beauty Studio WooCommerce Class
 *
...
if ( ! class_exists( 'Beauty_Studio_WooCommerce' ) ) :

	/**
	 * The Beauty_Studio WooCommerce Integration class
	 */
	class Beauty_Studio_WooCommerce {
...
return new Beauty_Studio_WooCommerce();