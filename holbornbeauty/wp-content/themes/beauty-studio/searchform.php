...
<div class="search-block">
    <form action="<?php echo esc_url( home_url() )?>" class="searchform" id="searchform" method="get" role="search">
        <div>
            ...
            <?php
            $placeholder_text = '';
            if ( isset( $beauty_studio_customizer_all_values['beauty-studio-search-placeholder']) ):
                $placeholder_text = ' placeholder="' . esc_attr( $beauty_studio_customizer_all_values['beauty-studio-search-placeholder'] ). '" ';
            endif; ?>
