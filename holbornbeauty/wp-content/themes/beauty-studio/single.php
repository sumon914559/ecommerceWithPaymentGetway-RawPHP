...
<div class="wrapper inner-main-title">
	...
	<div class="container">
		<header class="entry-header init-animate">
			<?php
			$single_header_title = $beauty_studio_customizer_all_values['beauty-studio-single-header-title'];
        ...
        while ( have_posts() ) : the_post();
	        ...
	        if ( is_singular( 'attachment' ) ) {
		        ...
		        the_post_navigation( array(
			        'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'beauty-studio' ),
		        ) );
