    ...
    <div class="row">
        <div class="col-sm-4 filter-position">
            ...
            <div class="form-group">
                <div class="fg-line">
                    <div class="select">
                        <select class="selectpicker" id="wp-render-filter" <?php echo ' data-version="full-version-option"' ?>>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <input type="number" name="wdt-tablet-width" id="wdt-tablet-width"
                                   class="form-control input-sm" placeholder="Set tablet width in px" value="" <?php echo ' data-version="full-version-option-focus"' ?>/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <input type="number" name="wdt-mobile-width" id="wdt-mobile-width"
                                   class="form-control input-sm" placeholder="Set mobile width in px" value="" <?php echo ' data-version="full-version-option-focus"' ?>/>
                        </div>
                    </div>
                </div>
            </div>
