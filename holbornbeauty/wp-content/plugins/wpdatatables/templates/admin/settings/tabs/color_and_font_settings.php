                                ...
                                <div class="fg-line">
                                    <div class="select">
                                        <select id="wdt-table-font" data-name="wdtTableFont" class="selectpicker"
                                                title="Choose font for the table"<?php echo ' data-version="full-version-option"' ?>>
                                            <option value=""></option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="number" id="wdt-font-size" data-name="wdtFontSize"
                                                   class="form-control" min="0" value=""<?php echo ' data-version="full-version-option-focus"' ?>/>
                                        </div>
                                    </div>
                                </div>
                            </div>
