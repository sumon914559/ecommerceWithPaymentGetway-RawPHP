...
if(isset($_POST['btnSubmit']))
{
	...
	$sqlInsert = "INSERT INTO users (name,email,contactno,password) values('$name','$email','$contactno','$password')";
...
//$query=mysql_query("SELECT * FROM users WHERE email='sumon@yahoo.com' and password='123'");
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 create-new-account">
                            ...
                            <form class="register-form outer-top-xs" role="form" method="post" name="register" onSubmit="return valid();">
                                ...
                                <input type="submit" name="btnSubmit" class="btn-upper btn btn-primary checkout-page-button" value="Sign Up" >
                            </form>
